<?php
/**
 * Garbini_Ed functions and definitions
 *
...
/**
 * Garbini_Ed only works in WordPress 4.4 or later.
 */
...
function display_article_header($page_name_directory) {
    echo "<header class=\"main-nav-outer navbar-inner\" id=scroll>
	<div class=container>
		<div id=navigation>
			<ul class=\"main-nav nav-collapse garbini-collapse\">
				<li><a class=res-nav_click href=\"#home\"><img src=\"".$page_name_directory."/img/garbini-borderless-logo-200.png\" width=40 height=40 alt=\"\"></a></li>
